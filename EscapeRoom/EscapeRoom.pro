...
unrealRootPath=/home/helaly/unreal-engine/UnrealEngine
EscapeRoomRootPath=/home/helaly/Documents/Unreal Projects/EscapeRoom

gameProjectFile=/home/helaly/Documents/Unreal Projects/EscapeRoom/EscapeRoom.uproject
...
include(EscapeRoomSource.pri)
include(EscapeRoomHeader.pri)
include(EscapeRoomConfig.pri)
include(EscapeRoomIncludes.pri)
include(EscapeRoomDefines.pri)

EscapeRoom-Linux-Debug.commands = $$build EscapeRoom Linux Debug  -project="\"$$gameProjectFile\"" $$args
EscapeRoom-Linux-DebugGame.commands = $$build EscapeRoom Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EscapeRoom-Linux-Shipping.commands = $$build EscapeRoom Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EscapeRoom-Linux-Test.commands = $$build EscapeRoom Linux Test  -project="\"$$gameProjectFile\"" $$args
EscapeRoom.commands = $$build EscapeRoom Linux Development  -project="\"$$gameProjectFile\"" $$args

EscapeRoomEditor-Linux-Debug.commands = $$build EscapeRoomEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
EscapeRoomEditor-Linux-DebugGame.commands = $$build EscapeRoomEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EscapeRoomEditor-Linux-Shipping.commands = $$build EscapeRoomEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EscapeRoomEditor-Linux-Test.commands = $$build EscapeRoomEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
EscapeRoomEditor.commands = $$build EscapeRoomEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	EscapeRoom-Linux-Debug \
	EscapeRoom-Linux-DebugGame \
	EscapeRoom-Linux-Shipping \
	EscapeRoom-Linux-Test \
	EscapeRoom \
	EscapeRoomEditor-Linux-Debug \
	EscapeRoomEditor-Linux-DebugGame \
	EscapeRoomEditor-Linux-Shipping \
	EscapeRoomEditor-Linux-Test \
	EscapeRoomEditor \
